...
void _toggleCompactView() async {
  ...
  Widget _buildOperatorButton(Color accentColor) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context as BuildContext, '/operatore');
      },
      child: Container(
        ...
        child: ListTile(
          ...
          title: const Text('Seleziona Operatore', style: TextStyle(color: Colors.black)),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            Transform.scale(
              scale: 1.1, // Slightly reduced the size for a more balanced look
              child: Switch(
                value: value, // Use the current value (true or false)
                onChanged: onChanged, // Pass the callback for toggling
                activeColor: accentColor,
                activeTrackColor: value
                    ? Color.fromARGB(255, 255, 230, 171) // Background color when selected
                    : const Color.fromARGB(255, 220, 220, 220), // Lighter active track color
                inactiveTrackColor: const Color.fromARGB(255, 218, 218, 218), // Color for unselected state
                inactiveThumbColor: Colors.white, // Color of the thumb in unselected state
...
Widget _buildListTile({
 ...
 Widget _buildUpdateButton(Color accentColor) {
      ...
      child: ElevatedButton(
        ...
        onPressed: _isUpdating ? null : () async {
          ...
          setState(() {
            ...
            _buttonText = 'Updated Successfully';
          });
        ...
        child: _isUpdating
            ...
            : Text(_buttonText), // Dynamically changing the button text
      ),
    );
  }
  ...
  Widget _buildLogoutButton(BuildContext context) {
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        onPressed: () => _logout(context), // Wrap in function
  ...
  Future<void> _updateSettings() async {
    ...
    await HomePageState.loadAndSaveImpostazioni(context as BuildContext, _isOnline);
